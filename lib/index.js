...
var MIN_LENGTH_SUGGEST = 2;
var airports_1 = __importDefault(require("./airports"));
function useAirportsAutocomplete(_a) {
    var _this = this;
    var _b = _a === void 0 ? {} : _a, _c = _b.debounce, debounce = _c === void 0 ? DEFAULT_DEBOUNCE : _c, _d = _b.minLengthSuggest, minLengthSuggest = _d === void 0 ? MIN_LENGTH_SUGGEST : _d, _e = _b.defaultValue, defaultValue = _e === void 0 ? "" : _e;
    var _f = (0, react_1.useState)(false), ready = _f[0], setReady = _f[1];
    var _g = (0, react_1.useState)(defaultValue), value = _g[0], setVal = _g[1];
    var _h = (0, react_1.useState)({
        loading: false,
        hasError: false,
        data: [],
    }), suggestions = _h[0], setSuggestions = _h[1];
